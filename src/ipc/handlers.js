...
// New: Export saveUserName for saving the username only.
export const saveUserName = (walletAddress, userName) =>
  window.electronAPI.saveUserName({ walletAddress, userName });
